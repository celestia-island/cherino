...
/// entelecheia-network default (inlined from the plana core constants when
/// this crate was extracted; the value is kept for existing deployments).
const DEFAULT_NETWORK: &str = "entelecheia-network";
